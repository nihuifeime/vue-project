<template>
    <div id="gysp">
        ...
        <app-head id="gysp-head"></app-head>
        <app-left id="gysp-left"  ref="leftchild"></app-left>
        <app-right id="gysp-right"  ref="rightchild"></app-right>
    </div>
</template>
<style>
    #gysp{
...
import head from '@/components/gysp/head'
import right from '@/components/gysp/right'
import left from '@/components/gysp/left'
...
export default {
    ...
    methods: {
        ...
        axioss:function(){
            this.$refs.leftchild.gyspleftchart()
        }
    },
    mounted(){
        this.mappp()
