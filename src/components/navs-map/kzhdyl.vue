<template>
    <div id="kzhdyl">
        ...
        <app-head id="kzhdyl-head"></app-head>
        <app-left id="kzhdyl-left"  ref="leftchild"></app-left>
        <app-right id="kzhdyl-right"  ref="rightchild"></app-right>
    </div>
</template>
<style>
    #kzhdyl{
...
import head from '@/components/kzhdyl/head'
import right from '@/components/kzhdyl/right'
import left from '@/components/kzhdyl/left'
...
export default {
    ...
    methods: {
        ...
        axioss:function(){
            this.$refs.leftchild.kzhdylleftchart()
            this.$refs.rightchild.kzhdylrightchart()
        }
    },
    mounted(){
        this.mappp()
