<template>
    <div id="aqjc">
        ...
        <app-head id="aqjc-head"></app-head>
        <app-left id="aqjc-left"  ref="leftchild"></app-left>
        <app-right id="aqjc-right"  ref="rightchild"></app-right>
    </div>
</template>
<style>
    #aqjc{
...
import head from '@/components/aqjc/head'
import right from '@/components/aqjc/right'
import left from '@/components/aqjc/left'
...
export default {
    ...
    methods: {
        ...
        axioss:function(){
            this.$refs.leftchild.aqjcleftchart()
            this.$refs.rightchild.aqjcrightchart()
        }
    },
    mounted(){
        this.mappp()
