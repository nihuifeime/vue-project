<template>
    <div id="swjc">
        ...
        <app-head id="swjc-head"></app-head>
        <app-left id="swjc-left" ref="leftchild"></app-left>
        <app-right id="swjc-right" ref="rightchild"></app-right>
    </div>
</template>
<style>
    #swjc{
...
import head from '@/components/swjc/head'
import right from '@/components/swjc/right'
import left from '@/components/swjc/left'
...
export default {
    ...
    methods: {
        ...
        axioss:function(){
            this.$refs.leftchild.swjcleftchart()
            this.$refs.rightchild.swjcrightchart()
        }
    },
    mounted(){
        this.mappp()
